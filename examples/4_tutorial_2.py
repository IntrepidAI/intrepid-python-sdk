...
LAT_0 = 50.8470310278603
LON_0 = 4.3524960800946175
ALT_0 = 0  # in meters
MAX_SPEED = 1.0  # Maximum drone speed (units per second)
counter = 0  # Waypoint counter
SAFE_DISTANCE = 10.0  # Example safe distance from waypoints


# Callback function to execute when inputs are ready
def my_callback_function(agent_id: int, drone_position: list, trajectory: list, something: list) -> (float, float, float, float, float):
    global counter
